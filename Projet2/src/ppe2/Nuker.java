...
public class Nuker extends Personnage{
	...
	public Nuker(String nom,int pointvie, int nbreatt,String type) {
...
//				if (nbrAle == 0) { 
//					this.nbreatt = this.nbreatt*(1+1/100);
//					}
//				else if (nbrAle == 1) {	
//					this.nbreatt = this.nbreatt*(1+2/100);
//					}
//				else if (nbrAle == 2) { 
//					this.nbreatt = this.nbreatt*(1+3/100);
//					}
